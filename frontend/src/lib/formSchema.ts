...
export const formSchema = z.object({
    ...
    profilePicture: z.instanceof(FileList).optional(), // FileList
    ...
    actionPhotos: z.instanceof(FileList).optional(),
    ...
    references: z.instanceof(FileList).optional(),
    certifications: z.instanceof(FileList).optional(),
    moreMedia: z.instanceof(FileList).optional(),
