  ...
  return (
    <Section>
      <div className="relative py-12 sm:py-16 lg:py-20">
        {/* soft backdrop (fixed light) */}
        <div className="pointer-events-none absolute inset-x-0 bottom-0 top-10 -z-10 bg-gradient-to-b from-slate-50 to-white" />
                  ...
                  <CardHeader className="flex flex-row items-center gap-4">
                    <div
                      className="flex h-12 w-12 items-center justify-center rounded-xl border border-slate-200
                                 bg-slate-50 text-slate-700 transition
                                 group-hover:border-emerald-200 group-hover:bg-emerald-50 group-hover:text-emerald-700"
                    >
