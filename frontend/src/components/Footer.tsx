      ...
      <div className="container grid grid-cols-1 md:grid-cols-5 gap-8">
        <div className="col-span-1 md:col-span-2 text-center md:text-left">
          <Link href="#" className="flex items-center space-x-2 mb-4 justify-center md:justify-start">
            <Image src="/images/logo.png" alt="SportsMarkers" width={32} height={32} />
          ...
          <div className="flex items-center gap-4 justify-center md:justify-start">
            <Link href="https://www.linkedin.com/company/squareresults/posts/?feedView=all" className="text-muted-foreground hover:text-foreground">
            ...
            <Link href="https://www.squareresults.com/" className="text-muted-foreground hover:text-foreground">
            ...
            <a
              ...
              aria-label="Email contact@squareresults.com"
            >
        ...
        <div className="col-span-1 text-center md:text-left">
          ...
          <ul className="space-y-2">
            ...
            <li><Link href="#" className="text-muted-foreground hover:text-foreground"></Link></li>
          </ul>
        </div>
