            ...
            <div className="relative flex justify-between">
              <div className="w-1/5">
                <div className="relative">
                  <div className="w-8 h-8 mx-auto bg-blue-500 rounded-full text-lg text-white flex items-center justify-center">
                    1
                  </div>
                </div>
              ...
              <div className="w-1/5">
                <div className="relative">
                  <div className="w-8 h-8 mx-auto bg-green-500 rounded-full text-lg text-white flex items-center justify-center">
                    5
                  </div>
                </div>
